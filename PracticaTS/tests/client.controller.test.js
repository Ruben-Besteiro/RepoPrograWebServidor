...
describe('Client Controller', () => {
    ...
    describe('updateClient', () => {
        it('debería actualizar un cliente si existe y no está archivado', async () => {
            ...
            Client.findOneAndUpdate.mockResolvedValue(clientMock);
    ...
    describe('archiveClient', () => {
        it('debería marcar el cliente como deleted: true', async () => {
            req.params.id = 'c1';
            const saveMock = jest.fn().mockResolvedValue(true);
            Client.findById.mockResolvedValue({ _id: 'c1', deleted: false, save: saveMock });
    ...
    describe('restoreClient', () => {
        it('debería restaurar un cliente archivado', async () => {
            req.params.id = 'c1';
            const saveMock = jest.fn().mockResolvedValue(true);
            Client.findById.mockResolvedValue({ _id: 'c1', deleted: true, save: saveMock });
    ...
    describe('getArchivedClients', () => {
        it('debería retornar clientes archivados', async () => {
            Client.find.mockResolvedValue([{ name: 'Archived' }]);
    ...
    describe('Errors and Catch blocks', () => {
        ...
        it('updateClient falla en el catch', async () => {
            Client.findOneAndUpdate.mockRejectedValue(new Error('DB Error'));
